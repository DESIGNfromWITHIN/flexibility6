...
$packageNameLower = 'flexibility6'; /* No spaces, no dashes */

$components = array(
    /* These are used to define the package and set values for placeholders */
    'packageName' => 'flexibility6',  /* No spaces, no dashes */
    'packageNameLower' => $packageNameLower,
    'packageDescription' => 'Responsive MODX Revolution template based on Foundation 6 from ZURB.',
    'version' => '1.0.0',
    'release' => 'pl',
    ...
    'packageDocumentationUrl' => 'https://github.com/DESIGNfromWITHIN/flexibility6/blob/master/README.md',
    'copyright' => '2017',
    ...
    */
    ...
    'namespaces' => array(
        'flexibility6' => array(
            'name' => 'flexibility6',
            'path' => '{core_path}components/flexibility6/',
            'assets_path' => '{assets_path}components/flexibility6/',
        ),
    ),
